...
export default function PrivacyPolicyPage() {
  ...
  if (!sectionData || !sectionData.Legal || !sectionData.Legal.variants.PrivacyPolicy) {
    notFound();
  }

  const breadcrumbData = {
    ...(commonData.breadcrumbs?.PrivacyBreadcrumb || { title: 'Privacy Policy', paths: [], bgImage: '/banner/breadcrumb.jpg' }),
  ...
  return (
    <main className="bg-white">
      ...
      <LegalPageContent data={sectionData.Legal.variants.PrivacyPolicy} />
