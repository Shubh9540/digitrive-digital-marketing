...
export default function CookiePolicyPage() {
  ...
  if (!sectionData || !sectionData.Legal || !sectionData.Legal.variants.CookiePolicy) {
    notFound();
  }

  const breadcrumbData = {
    ...(commonData.breadcrumbs?.CookieBreadcrumb || { title: 'Cookie Policy', paths: [], bgImage: '/banner/breadcrumb.jpg' }),
    title: 'Cookie Policy',
    paths: [
      { label: 'Home', url: '/' },
      { label: 'Cookie Policy' }
  ...
  return (
    <main className="bg-white">
      ...
      <LegalPageContent data={sectionData.Legal.variants.CookiePolicy} />
