    ...
    <div className="flex flex-col gap-12 w-full">
      ...
      <div className="w-full h-[400px] rounded-2xl overflow-hidden relative group">
        ...
        <div className="absolute inset-0 p-8 md:p-12 flex flex-col justify-center max-w-2xl">
          ...
          <h1 className="text-4xl md:text-4xl lg:text-5xl font-bold text-white mb-2 leading-tight">
            {data.title}
          </h1>
      ...
      <div className="flex flex-col gap-6">
        <div>
          <h2 className="text-3xl font-bold text-white relative inline-block pb-3 mb-2">
            ...
            <span className="text-[var(--color-primary)]">
              {data.serviceCenter.titleHighlight}
            </span>
            <span className="absolute bottom-0 left-0 w-16 h-[3px] bg-[var(--color-primary)]"></span>
          </h2>
        </div>
            ...
            return (
              <div
                ...
                className={`border rounded-lg overflow-hidden transition-colors ${
                  isOpen
                    ? "border-[var(--color-primary)]/40 bg-[#05101f]"
                    : "border-gray-800/60 bg-[#020914]"
                }`}
              >
                <div
                ...
                >
                  <h4
                    className={`font-bold text-sm ${isOpen ? "text-white" : "text-gray-300"}`}
                  >
                    {q.question}
                  </h4>
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 transition-colors ${
                      isOpen
                        ...
                        : "bg-[#05101f] text-[var(--color-primary)] border border-gray-800"
                    }`}
                  >
                    {isOpen ? (
                ...
                {isOpen && (
                  <div className="p-4 pt-10 lg:pt-20 border-t border-[var(--color-primary)]/20 mt-2">
