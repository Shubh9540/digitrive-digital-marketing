...
const renderIcon = (iconName: string, className?: string) => {
  const props = {
    className: className || "w-5 h-5 text-[var(--color-primary)]",
  };
  switch (iconName) {
    case "FaPhoneAlt":
...
export const ContactSection = ({ data }: { data?: DigitalContactData }) => {
  ...
  return (
    <section className="bg-[#020914] pt-10 lg:pt-206 lg:pt-10 lg:pt-204 text-white font-sans">
          ...
          <div>
            ...
            <form className="space-y-6">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                <button
                  type="submit"
                  className="bg-[var(--color-primary)] text-black font-bold py-3 px-6 rounded flex items-center justify-center gap-3 hover:bg-white transition-colors"
                >
                ...
                <button
                  type="reset"
                  className="bg-[#05101f] border border-[var(--color-primary)]/50 text-white font-bold py-3 px-6 rounded flex items-center justify-center gap-3 hover:border-[var(--color-primary)] transition-colors"
                >
                  {data.form.resetText}
                  <div className="bg-white rounded-full p-1.5 flex items-center justify-center">
