...
const renderIcon = (iconName: string, className?: string) => {
  ...
  switch (iconName) {
    case "FaMobileAlt":
      return <FaMobileAlt {...IconProps} />;
    case "FaSearch":
      return <FaSearch {...IconProps} />;
    case "FaChartLine":
      return <FaChartLine {...IconProps} />;
    case "FaMousePointer":
      return <FaMousePointer {...IconProps} />;
    ...
    case "FaHandPointUp":
      return <FaHandPointUp {...IconProps} />;
    default:
      return null;
  }
};
...
export const BlogDetailContent = ({ data }: { data?: BlogDetailData }) => {
  ...
  return (
    <section className="bg-[#020914] py-10 lg:py-200 lg:py-10 lg:py-2002 lg:py-10 lg:py-200 text-white font-sans">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Hero Section */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-16">
          <div className="flex flex-col">
            <div className="mb-6">
              <span className="inline-block px-4 py-10 lg:py-200 lg:py-10 lg:py-200.5 rounded-full border border-[var(--color-primary)] text-[var(--color-primary)] text-xs font-semibold tracking-wide">
                {data.category}
              </span>
            </div>
            <h1 className="text-4xl sm:text-4xl lg:text-5xl lg:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              {data.title}
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-gray-500">
                  {data.author.date} <span className="mx-2">•</span>{" "}
        ...
        <div className="w-full">
          ...
          <div className="bg-[#05101f] rounded-2xl p-8 sm:p-10 mb-16 relative border border-gray-800 shadow-lg">
            <div className="absolute top-8 left-6 sm:left-10 text-[var(--color-primary)] opacity-80 text-4xl md:text-5xl lg:text-6xl font-serif leading-none">
              &ldquo;
            </div>
