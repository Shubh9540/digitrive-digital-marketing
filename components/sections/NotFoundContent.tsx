...
export const NotFoundContent = ({ data }: { data?: DigitalNotFoundData }) => {
  ...
  return (
    <section className="bg-[#0b101e] flex flex-col items-center justify-center min-h-[calc(100vh-80px)] py-10 lg:py-20 px-4 text-center overflow-hidden">
      {/* ── Main 404 block ── */}
      <div
        className="relative w-full max-w-[900px] mx-auto mb-2 flex justify-center items-center"
        style={{ paddingTop: "clamp(40px, 8vw, 70px)" }}
      >
        {/* ── Scattered decorative SVG elements ── */}
        <svg
          className="absolute top-[8%] left-[3%] opacity-70"
          width="10"
          height="10"
        >
          <circle cx="5" cy="5" r="5" fill="#00c5c8" />
        </svg>
        <svg
          className="absolute top-[40%] left-[1%] opacity-40"
          width="22"
          height="22"
        >
          <circle
        ...
        <svg
          className="absolute bottom-[10%] left-[8%] opacity-60"
          width="7"
          height="7"
        >
          <circle cx="3.5" cy="3.5" r="3.5" fill="#00c5c8" />
        </svg>
        <svg
          className="absolute top-[5%] left-[22%] opacity-30"
          width="14"
          height="14"
        >
          <line
        ...
        <svg
          className="absolute bottom-[5%] left-[30%] opacity-25"
          width="12"
          height="12"
        >
          <line
        ...
        <svg
          className="absolute top-[45%] right-[1%] opacity-60"
          width="8"
          height="8"
        >
          <circle cx="4" cy="4" r="4" fill="#00c5c8" />
        </svg>
        <svg
          className="absolute bottom-[12%] right-[6%] opacity-40"
          width="20"
          height="20"
        >
          <circle
        ...
        <svg
          className="absolute top-[18%] right-[23%] opacity-60"
          width="6"
          height="6"
        >
          <circle cx="3" cy="3" r="3" fill="#00c5c8" />
        </svg>
        ...
        <div
          ...
          style={{
            ...
            height: "clamp(90px, 28vw, 320px)",
            margin: "0 -3%",
          }}
        >
          {/* Speech bubble with ? */}
          <div
            className="absolute z-20 w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16"
