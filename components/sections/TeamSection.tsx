      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight mb-6">
            ...
            <span className="text-[var(--color-primary)] underline decoration-[var(--color-primary)] underline-offset-8 decoration-2">
              {data.titlePart2}
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {data.members.map((member) => (
            ...
            >
              ...
              <div className="absolute top-0 left-1/2 -translate-x-1/2 z-20 bg-[var(--color-primary)] text-black text-[10px] font-bold uppercase tracking-widest px-4 py-10 lg:py-200 lg:py-10 lg:py-200.5 rounded-b-lg shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
                Team Lead
              </div>
