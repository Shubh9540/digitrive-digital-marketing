...
const renderMetricIcon = (iconName: string) => {
  ...
  switch (iconName) {
    ...
    case "FaChartLine":
      return <FaChartLine className={cls} />;
    case "FaArrowDown":
      return <FaArrowDown className={cls} />;
    case "FaDollarSign":
      return <FaDollarSign className={cls} />;
    case "FaTrophy":
      return <FaTrophy className={cls} />;
    case "FaChartBar":
      return <FaChartBar className={cls} />;
    case "FaPhone":
      return <FaPhone className={cls} />;
    case "FaCalendar":
      return <FaCalendar className={cls} />;
    default:
      return <FaChartLine className={cls} />;
  }
};
  ...
  return (
    <div className="bg-[#020914]">
      ...
      <div className="bg-[#05101f] border-b border-gray-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-200 lg:py-10 lg:py-2002 lg:py-10 lg:py-200 lg:py-10 lg:py-2006">
                ...
                {data.title.includes(data.titleHighlight) ? (
                  <>
                    {data.title.substring(
                      0,
                      data.title.indexOf(data.titleHighlight),
                    )}
      ...
      {/* Sections */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-200 lg:py-10 lg:py-2002 lg:py-10 lg:py-200 lg:py-10 lg:py-2006 flex flex-col gap-0">
        {data.sections.map((section, idx) => (
          <div key={section.id}>
            {/* Section Row */}
            <div className="py-10 lg:py-200 lg:py-10 lg:py-2000 flex flex-col lg:flex-row gap-10 items-start">
              ...
              <div className="w-full lg:w-[50%] flex-shrink-0">
                ...
                {!section.bullets && !section.metrics && <SocialGrowthSVG />}
              </div>
            </div>
