...
export const MissionSection = ({ data }: { data?: MissionVisionSectionData }) => {
  if (!data) return null;
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-5/12 relative z-10">
            <div className="relative overflow-hidden group" style={{ borderRadius: '20px 100px 20px 20px' }}>
              <Image
                src={data.image}
                alt="Mission"
                width={800}
              ...
              {data.overlayText && (
                <div className="absolute inset-0 bg-gradient-to-r from-[#051024]/80 to-transparent">
                  <div className="absolute bottom-6 left-6">
                    ...
                    <div className="w-12 h-[3px] bg-[#c49250] mt-4"></div>
                  </div>
                </div>
              )}
            </div>
