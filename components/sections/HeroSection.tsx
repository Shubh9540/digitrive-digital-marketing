...
const renderIcon = (iconName: string) => {
  switch (iconName) {
    ...
    case "FaBullseye":
      return <FaBullseye className="w-6 h-6" />;
    case "FaGlobe":
    ...
    <section className="relative w-full h-[550px] lg:h-[650px] overflow-hidden bg-black flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 h-full">
        ...
        <div className="flex flex-col justify-center animate-fade-in-up lg:col-span-7 h-full">
          ...
          <h1 className="text-4xl sm:text-4xl lg:text-5xl lg:text-7xl font-extrabold text-white leading-tight mb-4 tracking-tight">
            {data.titlePart1}{" "}
                ...
                return (
                  ...
                  >
                    <div className="relative group cursor-pointer">
                      ...
                      {/* Tooltip */}
                      <div className="absolute top-full left-1/2 -translate-x-1/2 mt-3 bg-black/80 text-white text-xs px-3 py-10 lg:py-200 lg:py-10 lg:py-200.5 rounded opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all whitespace-nowrap">
                        {item.label}
                      </div>
                    </div>
                  </div>
