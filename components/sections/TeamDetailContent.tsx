...
import { FaEnvelope, FaPhone, FaGlobe, FaUser, FaBirthdayCake, FaMapMarkerAlt } from 'react-icons/fa';

export const TeamDetailContent = ({ data }: { data: TeamDetailData }) => {
  return (
    <div className="bg-[#020914] py-16 lg:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="w-full lg:w-[400px] flex-shrink-0">
            <div className="relative w-full h-[450px] lg:h-[500px] rounded-2xl overflow-hidden border border-gray-700/50 bg-[#05101f]">
              ...
              <div className="absolute top-8 right-0 bg-[var(--color-primary)] px-2 py-6 rounded-l-lg shadow-lg">
                <p className="text-[#020914] text-xs font-bold tracking-[0.2em] whitespace-nowrap" style={{ writingMode: 'vertical-rl', textOrientation: 'mixed' }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-12">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${data.contact.email}`} className="text-gray-400 text-sm hover:text-[var(--color-primary)] transition-colors">
                    {data.contact.email}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-white text-sm font-semibold mb-1">Blood Group</p>
                  <p className="text-gray-400 text-sm">{data.contact.bloodGroup}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href={`tel:${data.contact.phone.replace(/\s+/g, '')}`} className="text-gray-400 text-sm hover:text-[var(--color-primary)] transition-colors">
                    {data.contact.phone}
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href={`https://${data.contact.website}`} target="_blank" rel="noopener noreferrer" className="text-gray-400 text-sm hover:text-[var(--color-primary)] transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-tight">{data.contact.address}</p>
                </div>
              </div>
        ...
        <div>
          <h3 className="text-2xl font-bold text-white mb-6">
            Expertise <span className="text-[var(--color-primary)]">& Skills</span>
          </h3>
              ...
              {data.skills.map((skill) => (
                <div key={skill.id} className="w-full">
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <span className="text-[var(--color-primary)] text-xs font-bold">{skill.percentage}</span>
                  </div>
