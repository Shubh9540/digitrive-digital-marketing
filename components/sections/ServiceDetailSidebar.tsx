            ...
            return (
              ...
              >
                ...
                <div className={`w-8 h-8 rounded-full flex items-center justify-center transition-all ${
                  isActive ? 'bg-[#00e5ff] text-[#051024]' : 'bg-[#102a4c] text-white group-hover:bg-[#c49250]'
                }`}>
      ...
      <div className="bg-[#0c1f40] rounded-xl overflow-hidden p-6 border border-[#1a3861] hover:bg-[#102a4c] transition-colors group cursor-pointer shadow-xl">
        <Link href="#" className="flex items-center justify-center gap-6">
          ...
          <div className="text-left">
            <h4 className="text-white font-bold text-lg leading-tight">Download<br/>Brochure</h4>
          </div>
        </Link>
      </div>

      {/* Contact Widget */}
      <div className="relative rounded-xl overflow-hidden shadow-xl" style={{ minHeight: '320px' }}>
        ...
        <div className="relative z-10 p-8 flex flex-col items-center text-center h-full justify-between gap-6">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div>
              <p className="text-[#00e5ff] text-sm font-medium mb-1">Phone Number</p>
              <p className="text-xl md:text-2xl font-bold text-white">{data.contact.phone}</p>
            </div>
          </div>
        </div>
      </div>
