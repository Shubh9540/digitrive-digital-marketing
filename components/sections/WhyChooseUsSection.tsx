...
export const WhyChooseUsSection = ({
  ...
  data?: DigitalWhyChooseUsData;
}) => {
  if (!data) return null;

  return (
    <section className="py-10 lg:py-200 lg:py-10 lg:py-2002 lg:py-10 lg:py-200 bg-[#020914] overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col z-20">
            ...
            {/* Title */}
            <h2 className="text-3xl sm:text-4xl md:text-[50px] font-bold text-white leading-[1.1] mb-6">
              {data.titlePart1
                .replace(/\\n/g, "\n")
                .split("\n")
                .map((line, i, arr) => (
            ...
            <div className="flex flex-col sm:flex-row gap-8 sm:gap-6 items-center sm:items-stretch">
              ...
              <div className="flex-1 flex flex-col gap-5 w-full">
                {data.features.map((feature) => (
                  <div
                    key={feature.id}
                    className="rounded-2xl border border-[var(--color-primary)]/20 bg-transparent p-6 flex flex-col sm:flex-row gap-5 items-start sm:items-center"
                  >
                    ...
                    <div>
                      <h4 className="text-white font-bold text-[20px] mb-2">
                        {feature.title}
                      </h4>
              ...
              <div className="hidden md:flex flex-col items-center justify-center gap-6 flex-shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div className="w-[56px] rounded-full border border-gray-700 bg-transparent p-1.5 pb-2 flex flex-col items-center gap-2">
                    <Link
                      href={data.teamRedirectUrl}
                      className="w-[44px] h-[44px] rounded-full bg-[var(--color-primary)] flex items-center justify-center text-white font-bold text-lg hover:scale-105 transition-transform flex-shrink-0"
                    >
                    ...
                    <div className="flex flex-col -space-y-2 mt-1">
                      {data.teamImages.map((img, i) => (
                        <div
                          key={i}
                          className="w-[44px] h-[44px] rounded-full overflow-hidden border-2 border-[#020914] relative z-10"
                        >
                          <Image
                            src={img}
                            alt="Team"
          ...
          <div className="relative w-[90%] sm:w-full aspect-[4/5] max-w-[320px] md:max-w-[400px] lg:max-w-[500px] mx-auto mt-12 lg:mt-0 z-10">
            ...
            <div className="absolute bottom-6 lg:bottom-8 left-1/2 -translate-x-1/2 z-20 w-[140px] sm:w-[170px] lg:w-[190px] aspect-square rounded-full bg-[#020b16] border border-[#1a2639] flex flex-col items-center justify-center p-3 sm:p-4 text-center shadow-[0_15px_40px_rgba(0,0,0,0.5)]">
              <div className="w-[36px] h-[36px] sm:w-[48px] sm:h-[48px] rounded-full bg-[var(--color-primary)] flex items-center justify-center text-white mb-1 sm:mb-2 shadow-[0_0_15px_rgba(0,194,199,0.4)]">
                <FaUsers className="w-4 h-4 sm:w-5 sm:h-5" />
              </div>
              <h2 className="text-[38px] sm:text-[52px] lg:text-[56px] font-normal text-[var(--color-primary)] mb-0 leading-none tracking-tight">
                {data.badgePercentage}
              </h2>
              <p className="text-white text-[9px] sm:text-[10px] lg:text-[11px] font-semibold whitespace-pre-line leading-[1.3] mt-1 tracking-wide">
