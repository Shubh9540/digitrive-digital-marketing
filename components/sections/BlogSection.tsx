...
export const BlogSection = ({ data }: { data?: DigitalBlogData }) => {
  ...
  return (
    <section className="py-10 lg:py-200 lg:py-10 lg:py-2000 lg:py-10 lg:py-200 lg:py-10 lg:py-2006 bg-[#020914] border-t border-gray-800/60">
            ...
            >
              ...
              <div className="relative w-full h-60 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 bg-[#0a192f]/90 backdrop-blur-md rounded-lg flex flex-col items-center justify-center p-2 min-w-[50px] shadow-lg border border-white/5">
                  <span className="text-[var(--color-primary)] font-bold text-xl leading-none mb-1">
                    {blog.day}
                  </span>
